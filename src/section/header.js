...
export const Header = (props) => {
  ...
  return (
    ...
    <div className='text-center md:text-start p-4 uppercase tracking-wide h-fit text-md md:text-xl content-center font-medium md:font-semibold text-blue-200  '> {/* top left content */}
